...
local ui = loadstring(game:HttpGet('https://raw.githubusercontent.com/Bestxemchuaa/Bestxemchuaa/main/Test/Testui_Gui.txt'))()
spawn(function()
   while wait() do
      if getgenv().RainbowUi then
         ui:setTheme("TextColor",Color3.fromHSV(tick() * 24 % 255/255, 1, 1))
         ui:setTheme("Glow",Color3.fromHSV(tick() * 24 % 255/255, 1, 1))
      end
   end
end)
